...
// real to hit. Off by default (--seed-update); see PLAN.md for why this is
// implemented directly at the storage layer instead of via the REST API's
// signed-upload path.
package main
...
// required, since this all runs before "dg-sat serve" ever starts.
