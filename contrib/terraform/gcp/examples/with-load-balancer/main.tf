...
module "server" {
  ...
  # The instance always gets an external IP (see the GCP module README); it
  # only needs to be static in the Caddy topology, where it is baked into the
  # gateway certificate and device configuration.
